...
$roles;
if (listar_rolesx($roles, $mensaje)) {
    echo $mensaje . "<br>";
} else {
...
?>
  ...
  <body onLoad="document.formulario.usuario.focus()"> 
	...
	if (isset($_SESSION["mensaje"])){
			...
			echo "<tr>";
			echo '<td align="right">Identificador Empleado</td>'; 
			echo '<td>'.$_SESSION['Identificador'].'</td>'; 
			echo "</tr>";
		    
			echo '<td align="left"><a href="altaempleado.php">Volver</a></td>'; 
			echo "</tr>";
			}else{
	...
	<h1 class="auto-style1">Empleado</h1> 
    <form name="formulario" action="../logica/empleado.php" method="POST"> 
    <table align="center" width="225" cellspacing="2" cellpadding="2" border="0"> 
      ...
      <tr> 
        ...
        <td><input type="Text" name="Identificador" size="12" maxlength="50"></td> 
      </tr> 
	        <tr> 
