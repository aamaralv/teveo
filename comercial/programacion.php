...
<form name = "formularioProgramacion" method = "post" action = "accionprogramar.php">
				<br>
				<br>
				<br>
				<fieldset>
...
//echo "(" . $aa . $mm .  $dd . ")<br>"; 
								...
								echo $dias[date('N', $diaCelda)] . " " . date("d", $diaCelda) . " de " . $meses[date("m", $diaCelda)] . " de " . date("Y", $diaCelda);
								echo "</option>";
		...
		<tr>
			...
			<td>
				<?php echo $_SESSION["cuotasCubiertas"][$_SESSION["desplazamiento"]];
                                 if ($_SESSION["cuotas"][$_SESSION["desplazamiento"]] > $_SESSION["cuotasCubiertas"][$_SESSION["desplazamiento"]]) echo '<br><a href="accionprogramar.php?diaElegido=' . $_SESSION["desplazamiento"] . '">Elegir</a>';
                                ?>
			</td>
		</tr>
	</table>
...
<?php if($_SESSION["ver"] == 7) echo '<div style="display: block;">'; else echo '<div style="display: none;">';
	...
	for ($c1 = 0 ; $c1 < 7; $c1++){
		...
		echo $dias[date('N', $diaCelda)] ."-" . date("d", $diaCelda) . "<br>" . substr($meses[date("m", $diaCelda)],0,3) . "/" . date("Y", $diaCelda);
		echo "</td>";
                $diaX++;
	}
	echo "</tr>";
	...
	for ($c3 = 0; $c3 < 7; $c3++){
		echo '<td>' . $_SESSION["cuotasCubiertas"][$c3];
                if ($_SESSION["cuotas"][$c3] > $_SESSION["cuotasCubiertas"][$c3]) echo '<br><a href="accionprogramar.php?diaElegido=' . $c3 . '">Elegir</a>';
		echo "</td>";
	}
	echo "</tr>";
...
for($t =  0; $t < 4; $t++){
	...
	for ($c3 = 0; $c3 < 7; $c3++){
		echo '<td>' . $_SESSION["cuotasCubiertas"][$dialink];
                if ($_SESSION["cuotas"][$dialink] > $_SESSION["cuotasCubiertas"][$dialink]) echo '<br><a href="accionprogramar.php?diaElegido=' . $dialink . '">Elegir</a>';
		echo "</td>";
		$dialink++;
	}
	echo "</tr>";
