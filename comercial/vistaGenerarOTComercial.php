	...
	<body>
		<div align="center">
			<div style="width:680px" align="left">
				...
				<br>			
				<form name = "formulario" method = "post" action = "controladorGeneraOTComercial.php">
					<fieldset>
						...
						<table >	
							...
							<tr>
								...
								<td> 
								<input type="text" name="tipoTarea" value="<?php echo  obtenerDescripcionTipoTarea($_SESSION["orden"]["TipoTarea"]); ?>" disabled>
								</td>
								<td>
									Producto:
								</td>
