...
<html>
	...
	<body>
		...
		<div style="width:680px" align="left">
			...
			<form name = "formulario" method = "post" action = "controladorCerrarOTOperaciones.php">
				<fieldset>
					...
					<table width="100%">
						<tr align="center">
							<td width="50%">
								...
								<?php echo '<textarea name="comentarioEquipo" rows="4" cols="42" disabled>' . $_SESSION["orden"]["ComentariosEquipo"] . '</textarea>'; ?>
							</td>							
						</tr>
					</table>
				</div>
				...
				<div align="center">
					<input width="40px" type="submit" name="cancelar" value="  Volver al listado"><input width="40px" type="submit" name="confirmar" value="Confirmar Cierre">
				</div>
			</form>
		</div>
		</div>
