...
if ($_SESSION["paginaAnterior"] == "menusoporte.php"){
	$_SESSION["paginaAnterior"] = "controladorGeneraOTSoporte.php";
	$orden = array();
	$orden["TipoOrden"] = "R";
	...
	header("Location: vistaGenerarOTSoporte.php");
}
else{
	...
	{
		// se vuelcan a las variables de sesion los campos capturados en la pagina vistaGenerarOTSoporte.php
		$_SESSION["orden"]["TipoProducto"] = $_POST["producto"];
		$_SESSION["orden"]["TipoTarea"] = $_POST["tarea"];
	    ...
	    //$_SESSION["orden"]["FuncionesRequeridas"] = obtenerHabilidadesTipoProducto($_POST["producto"], $_SESSION["orden"]["TipoTarea"]);
		//else
		...
		$scriptSiguiente = "vistaGenerarOTSoporte.php";
							...
							if ($_SESSION["orden"]["Departamento"] != "")
								if ($_SESSION["orden"]["Localidad"] != "")
									if ($_SESSION["orden"]["Direccion"] != "")
									{
										...
										$scriptSiguiente = "controladorProgramarOTSoporte.php";
									}
									else
